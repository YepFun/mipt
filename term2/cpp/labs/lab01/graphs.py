...
# Strategy A
axes[0].scatter(sizes_strategy, strategy_a, label='StrategyA', color='blue')
...
# Strategy B
axes[1].scatter(sizes_strategy, strategy_b, label='StrategyB', color='green')
...
# Strategy C
axes[2].scatter(sizes_strategy, strategy_c, label='StrategyC', color='red')
...
axes[0].scatter(sizes_search, linear_avg, label='Linear_Avg', color='blue')
axes[0].set_xlabel('Sizes')
axes[0].set_ylabel('Time')
axes[0].set_title('Linear Average Time Complexity')
axes[0].legend()

axes[1].scatter(sizes_search, linear_worst, label='Linear_Worst', color='red')
axes[1].set_xlabel('Sizes')
axes[1].set_ylabel('Time')
...
axes[0].scatter(sizes_search, binary_avg, label='Binary_Avg', color='green')
axes[0].set_xlabel('Sizes')
axes[0].set_ylabel('Time')
axes[0].set_title('Binary Average Time Complexity')
axes[0].legend()

axes[1].scatter(sizes_search, binary_worst, label='Binary_Worst', color='orange')
axes[1].set_xlabel('Sizes')
axes[1].set_ylabel('Time')
...
axes[0].scatter(sizes_pair, pair_linear_avg, label='Pair_Linear_Avg', color='blue')
axes[0].set_xlabel('Sizes')
axes[0].set_ylabel('Time')
axes[0].set_title('Pair Linear Average Time Complexity')
axes[0].legend()

axes[1].scatter(sizes_pair, pair_linear_worst, label='Pair_Linear_Worst', color='red')
axes[1].set_xlabel('Sizes')
axes[1].set_ylabel('Time')
...
axes[0].scatter(sizes_pair, pair_binary_avg, label='Pair_Binary_Avg', color='green')
axes[0].set_xlabel('Sizes')
axes[0].set_ylabel('Time')
axes[0].set_title('Pair Binary Average Time Complexity')
axes[0].legend()

axes[1].scatter(sizes_pair, pair_binary_worst, label='Pair_Binary_Worst', color='orange')
axes[1].set_xlabel('Sizes')
axes[1].set_ylabel('Time')
